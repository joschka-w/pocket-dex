import { calculatePullRates } from '@/lib/utils/calculate-pull-rates';
import { toPercentage } from '@/lib/utils/format-to-percentage';

import { CardResult } from '@/lib/data/fetchCard';
